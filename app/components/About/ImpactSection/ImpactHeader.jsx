...
export default function ImpactHeader() {
  return (
    ...
    >
      ...
      >
        When fully deployed, BiliWatch has the potential to transform neonatal healthcare in Uganda and beyond.
        Our data-driven approach focuses on measurable outcomes that save lives.
      </motion.p>
    </motion.div>
  )
}
